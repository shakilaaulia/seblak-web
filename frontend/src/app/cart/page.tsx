  ...
  return (
    <div className="flex-1 flex flex-col bg-slate-50 min-h-screen relative font-sans text-gray-800">
      ...
      <header className="sticky top-0 bg-white border-b border-gray-100 px-4 py-3.5 z-30 flex items-center justify-between">
        ...
        <h1 className="text-base font-black text-red-700 tracking-wide text-center">Konfirmasi Pesanan</h1>
      ...
      <form onSubmit={handleOrderSubmit} className="flex-1 px-4 py-5 space-y-5 overflow-y-auto pb-32">
        ...
        <div className="bg-white rounded-3xl p-5 border border-gray-100 shadow-sm space-y-4">
          <div className="flex items-center space-x-2.5 text-red-700">
            ...
            <h2 className="text-sm font-black tracking-wide text-gray-900">Data Pemesan</h2>
          </div>

          <div className="space-y-3.5">
            <div>
              <label className="block text-[10px] font-black text-gray-400 uppercase tracking-wider mb-1.5">Nama</label>
              <input
                type="text"
                required
            ...
            <div>
              <label className="block text-[10px] font-black text-gray-400 uppercase tracking-wider mb-1.5">Nomor WhatsApp</label>
              <input
                type="tel"
                required
                className="w-full bg-gray-50 border border-transparent rounded-2xl px-4 py-3 text-xs font-semibold outline-none focus:bg-white focus:border-red-500 transition-all text-gray-700"
        ...
        <div className="bg-white rounded-3xl p-5 border border-gray-100 shadow-sm space-y-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-2.5 text-red-700">
              ...
              <h2 className="text-sm font-black tracking-wide text-gray-900">Ringkasan Pesanan</h2>
            </div>
          ...
          <div className="space-y-3.5">
            {cart.length === 0 ? (
              ...
              cart.map((item) => (
                <div key={item.id} className="flex items-center justify-between py-2 border-b border-gray-50 last:border-none last:pb-0">
        ...
        <div className="bg-white rounded-3xl p-5 border border-gray-100 shadow-sm space-y-3">
          <div className="flex items-center space-x-2.5 text-red-700">
            ...
            <h2 className="text-sm font-black tracking-wide text-gray-900">Catatan (Opsional)</h2>
          </div>
        ...
        <div className="bg-white rounded-3xl p-5 border border-gray-100 shadow-sm space-y-4">
          <div className="flex items-center space-x-2.5 text-red-700">
            ...
            <h2 className="text-sm font-black tracking-wide text-gray-900">Metode Pembayaran</h2>
          </div>
          ...
          >
            {isUploading ? (
              ...
              <div className="flex flex-col items-center text-center space-y-2">
                ...
                />
                <p className="text-[10px] font-extrabold text-emerald-800">{uploadedFileName}</p>
                <button
                  type="button"
              ...
              <div className="flex flex-col items-center text-center space-y-2">
                ...
                <p className="text-xs font-black text-red-700">Upload Bukti Pembayaran</p>
                <p className="text-[10px] text-gray-400 font-bold">Format: JPG, PNG (Max 5MB)</p>
              </div>
            )}
          </div>
        </div>
      ...
      {cart.length > 0 && (
        <div className="fixed bottom-0 inset-x-0 bg-white border-t border-gray-100/80 shadow-2xl px-5 py-4 flex items-center justify-between z-40">
          <div>
            ...
            <p className="text-lg font-black text-red-600 mt-0.5">{formatPrice(calculateTotal())}</p>
          </div>
